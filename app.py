...
st.markdown(
    f"""
    <div style="position: relative; height: 120px; background-color: #d0e7f9; border-radius: 10px; overflow: hidden; margin-bottom: 1rem; border: 2px solid #0077b6;">

        <!-- Water Fill Layer (gradient blue) -->
        <div style="
            position: absolute;
            top: 0;
            left: 0;
        ...
        <!-- Text Label -->
        <div style="position: absolute; bottom: 5px; width: 100%; text-align: center; font-weight: bold; color: #023e8a;">
            {program_pct_complete}% Complete
        </div>
    </div>
    """,
